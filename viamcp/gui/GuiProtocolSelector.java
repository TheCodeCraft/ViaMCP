...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_) {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.LIGHT_PURPLE.toString() + "ViaVersion",
                this.width / 4, 6, 16777215);
        GL11.glPopMatrix();
        
        Color color = new Color(20, 200, 100);
        Color color1 = new Color(20, 255, 255);
    ...
    class SlotList extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
            drawCenteredString(mc.fontRendererObj,(ViaMCP.getInstance().getVersion() ==
                    ProtocolCollection.values()[i].getVersion().getVersion() ? EnumChatFormatting.GREEN.toString() + EnumChatFormatting.BOLD.toString() :
                            EnumChatFormatting.DARK_AQUA.toString()) + ProtocolCollection.getProtocolById(
